...
If you've set up a deployment locally with the Qdrant Quickstart,
navigate to
If you've set up a deployment in a cloud cluster, find your Cluster URL in your
cloud dashboard, at Add `:6333/dashboard` to the end
of the URL.
## Access the Web UI
...
quick start to set up a cluster on localhost,
you can review our tutorial at
