...
```
The Sentence Transformers framework contains many embedding models. We'll take all-MiniLM-L6-v2 as it has a good balance between speed and embedding quality for this tutorial.
```python
