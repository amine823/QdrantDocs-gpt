...
For detailed cluster setup instructions, see the Cloud documentation.
...
## What's Next?
 Explore filtering to combine semantic search with structured queries
 Learn about collections and advanced configuration options
