...
If you want to integrate and send the generated metrics and traces to your existing observability tools like Promethues+Jaeger, Grafana or more, refer to the Official Documentation for OpenLIT Connections for detailed instructions.
