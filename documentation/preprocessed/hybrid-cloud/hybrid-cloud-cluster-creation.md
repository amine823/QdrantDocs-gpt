...
```
After configuring the API key secret, you can create JWTs with granular access control in the Qdrant Cluster UI. Please refer to the Granular access control with JWT documentation for more details.
#### Watch the Video
