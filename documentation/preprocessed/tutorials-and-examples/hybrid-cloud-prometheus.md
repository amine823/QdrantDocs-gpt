...
If you haven't installed Prometheus and Grafana yet, you can use the kube-prometheus-stack Helm chart to deploy them in your Kubernetes cluster.
A minimal example of installing the stack:
```bash
helm repo add prometheus-community the linked resource
...
```
Now you can open your web browser and go to ` Log in with the username `admin` and the password you retrieved earlier.
## Step 4: Import Qdrant Dashboard
Qdrant Cloud offers an example Grafana Dashboard on the Qdrant GitHub repository. This comes with built in views and graphs to get you started with monitoring your Qdrant Clusters.
