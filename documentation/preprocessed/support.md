...
To streamline this, we recommend using our support bundle script. It collects environment metadata (but no user data or API keys) and helps us troubleshoot more efficiently. The bundle includes collection names and configuration details.
...
> Please refer to the Qdrant Cloud SLA for full definitions of severity levels and guaranteed response times per your support tier.
