...
datasets. Qdrant also publishes datasets along with the
...
```
You can find a detailed description of the dataset in the Practice Datasets
...
You can load the dataset into Qdrant using the Python SDK.
...
```
Your collection is ready to be used for search! Please let us know using Discord
