...
If needed, you can install latest version of `nvidia-container-toolkit` from it's GitHub Releases page
...
Use the following operation to change on your existing collection:
```http
