...
This is always different. The size of the payload depends on the structure and content of your data. For instance:
...
Disk speed is also crucial. Contact us if you have specific requirements for high-volume searches in our Cloud.
...
```
Please refer to our multitenancy documentation for more details on partitioning data in a Qdrant.
