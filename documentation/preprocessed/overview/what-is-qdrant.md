...
These new databases shine in many applications like semantic search
and recommendation systems, and here, we'll
learn about one of the most popular and fastest growing vector databases in the market, Qdrant.
## What is Qdrant?
...
image of `qdrant` and connecting to it locally, or by trying out Qdrant's Cloud
...
efficiently. In traditional OLTP and OLAP
...
from -1 to 1, where -1 means the two vectors are completely dissimilar, and 1 indicates maximum similarity.
 Dot Product The dot product similarity metric is another way
...
are the terminologies you should get familiar with.
 ...
 Distance Metrics: These are used to measure
