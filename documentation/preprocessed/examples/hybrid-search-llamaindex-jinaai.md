...
## Components
 ...
 Database: Qdrant Hybrid Cloud, deployed in a managed Kubernetes cluster on DigitalOcean
 (DOKS)
...
1. To start using managed Kubernetes on DigitalOcean, follow the platform-specific documentation.
