...
describes a general process of creating a connector.
...
Embed v3, build the connector, and finally connect it with the Command-R model.
...
injection, and we will use it to provide both
...
uvicorn main:app
```
FastAPI exposes an interactive documentation at ` where we can test our endpoint. The
...
ngrok. We won't cover all the details in the tutorial, but their
Quickstart is a great resource describing the process step-by-step.
