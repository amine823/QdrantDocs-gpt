...
npm run dev
```
Refer to source code of example here.
## How It Works
...
const qdrant = new QdrantClient({
  url: process.env.QDRANT_URL || "the local Qdrant dashboard",
...
export class QdrantRetriever extends BaseRetriever {
   ...
   */
  async retrieve(input: string | BaseMessage[], options: RetrieveOptions): Promise {
...
## Further Reading
 ...
 VoltAgent Examples
 VoltAgent Qdrant Official Docs
