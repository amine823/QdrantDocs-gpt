...
const initialChatState: Chat[] = getSafeSavedChats() || [
    {
        ...
        content: [
            ...
            {
                emitter: "gpt",
                message: "This is an assistant for searching through the documentation of the [Qdrant vector database](https://qdrant.tech/documentation/). You can ask any question related to the documentation and I will do my best to provide you with a helpful answer. Feel free to ask me anything about the Qdrant documentation! 😉"
            }
        ],
    },
    {
        ...
        content: [
            {
                emitter: "user",
                message: "Follow me on \nLinkedin [@Amine Ezzeddine](https://www.linkedin.com/in/amine-ezzeddine-8b5a71223/)\nGitHub [amine823](https://github.com/amine823)"
            },
            {
                emitter: "gpt",
                message: "Thanks!"
